...
public interface Python2Visitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitDecorated(Python2Parser.DecoratedContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFpdef(Python2Parser.FpdefContext ctx);
	/**
	 * Visit a parse tree produced by {@link Python2Parser#fplist}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFplist(Python2Parser.FplistContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitWith_item(Python2Parser.With_itemContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTestlist_safe(Python2Parser.Testlist_safeContext ctx);
	/**
	 * Visit a parse tree produced by {@link Python2Parser#old_test}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOld_test(Python2Parser.Old_testContext ctx);
	/**
	 * Visit a parse tree produced by {@link Python2Parser#old_lambdef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOld_lambdef(Python2Parser.Old_lambdefContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDictorsetmaker(Python2Parser.DictorsetmakerContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTestlist1(Python2Parser.Testlist1Context ctx);
	/**
	 * Visit a parse tree produced by {@link Python2Parser#encoding_decl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEncoding_decl(Python2Parser.Encoding_declContext ctx);
	/**
